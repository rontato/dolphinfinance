  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white">
      <div className="w-full max-w-md py-12 px-4">
        ...
        <button onClick={handleGoogleSignup} className="w-full px-4 py-2 rounded bg-white border border-[#0058C0] text-[#0058C0] font-semibold hover:bg-[#e6f0fa] transition flex items-center justify-center">
